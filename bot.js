/**
 * SolBot Pro v4.0 — Production Trading Bot for Solana
 * ✅ Port binding intégré pour Render Web Service
 * ✅ Jupiter fallback endpoints (lite-api → api)
 * ✅ Stop-Loss/TP/Trailing/AntiRug/LiqExit
 * ✅ Analytics + Persistence + Webhooks + API Dashboard
 * 
...
const CONFIG = {
  ...
  // 🛑 Stop-Loss (default ON) - NOTE: Must be NEGATIVE
...
// ═══════════════════════════════════════════════════════════════════════════
// API SERVER + PORT BINDING — 35 routes + Render Web Service support
// ═══════════════════════════════════════════════════════════════════════════
function startApi(bot, wallet) {
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // 🔌 PORT BINDING — Render Web Service support
  // ═══════════════════════════════════════════════════════════════════════
  const PORT = parseInt(process.env.PORT) || 10000;
  app.listen(PORT, '0.0.0.0', () => {
    log('info', `🌐 API listening on port ${PORT}`, { version: VERSION, env: CONFIG.NODE_ENV });
  });
